...
import { Shield, Eye, Cookie, Globe, Lock, AlertCircle, CheckCircle2, Info, BookOpen } from 'lucide-react';
    ...
    >
      ...
      <div className="flex items-center justify-between space-x-3 mb-4">
        ...
        <button
          ...
          className="flex-shrink-0 px-4 py-2 bg-gradient-to-r from-primary to-purple-500 text-white rounded-lg hover:opacity-90 transition-opacity font-medium flex items-center gap-2 whitespace-nowrap"
        >
